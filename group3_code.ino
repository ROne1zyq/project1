    ...
    if(lenr>lenl)
      {
        ...
        analogWrite(M_right1,vlow4*1.2);
      }
      else
      {
        analogWrite(M_left2,0);
        analogWrite(M_left1,vlow4*prop*1.2);
        analogWrite(M_right2,0);
        analogWrite(M_right1,vhigh*1.2); 
      }
  }
  else if(lenl>30||lenr>30)
  {
    if(lenr>lenl)
    {
      analogWrite(M_left2,0);
    ...
    else if(lenr<14)  
    {
      ...
      analogWrite(M_left2,0);
      analogWrite(M_left1,155.5);
      analogWrite(M_right2,0);
      analogWrite(M_right1,200); 
    }
  }
  else{
    analogWrite(M_left2,0);
